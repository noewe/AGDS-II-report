...
```{r boruta, echo = F, fig.cap = "Figure 2: Variable importance based on Boruta."}
...
```{r predictions, include = F, echo = F}
# Load random forest model
...
```{r prob_plot, echo = F, message = F, fig.cap = "Figure 8: Predicted probability vs. Observed soil waterlog at 100 cm.", fig.height=2.5}
...
```{r roc, echo = F, fig.cap = "Figure 9: ROC curve for soil waterlog at 100 cm."}
